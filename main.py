...
def load_data():
    with st.spinner(text="Loading and indexing the Streamlit docs – hang tight! This should take 1-2 minutes."):
        ...
        system_prompt = (
            ...
            "Assume that all questions are related to the Streamlit Python library. Keep your answers technical "
            "and based on facts – do not hallucinate features."
        )
        
        query_wrapper_prompt = "some_prompt"  # Ensure this is correctly defined
